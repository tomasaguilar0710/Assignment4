...
public class Position {
    ...
    private IPositionState positionState;
    ...
    public void setState(IPositionState positionState){
    ...
    public boolean attack() {
        return this.positionState.takeHit(this);
    }
    ...
    public String revealContent(GridType gridType) {
        if ((this.boatAtPosition != null) && (gridType == GridType.OCEAN_GRID
                || gridType == GridType.CHEAT_GRID || this.hasBeenAttacked)) {
